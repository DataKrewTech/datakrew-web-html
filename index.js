...
<div class="nav-items">
  ...
  <div class="item-container">
  <li class="item"><a href="https://hygia.care/" class="act-tab "  name="COVID 19" id="act-tab" target="_blank">COVID 19</a> </li>
  </div>
...
const navDropdownCont = `
      ...
      <li><a href="https://hygia.care/" target="_blank">COVID 19</a></li>
`;
...
const footerContent = `
    <div class="container">
      ...
      <div class="mini-section">
      <h3 class="title"><a class=""  href="https://hygia.care/" target="_blank">COVID 19</a></h3>
